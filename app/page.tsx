          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 animate-fade-in-up">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-pink-500/20 border border-white/10 hover:border-pink-500/50 transition-all duration-300 hover:scale-110"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Facebook */}
              <a 
                href="https://www.facebook.com/share/1A2FSc1z5H/?mibextid=wwXIfr" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-blue-500/20 border border-white/10 hover:border-blue-500/50 transition-all duration-300 hover:scale-110"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* TikTok */}
              <a 
                href="https://tiktok.com/@tajijddagrssntosa" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-purple-500/20 border border-white/10 hover:border-purple-500/50 transition-all duration-300 hover:scale-110"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
